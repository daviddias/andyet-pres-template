# &yet presentation template based on reveal.js

## Usage

```
$ git clone
$ cd andyet-pres-template
$ npm i
$ npm start
```
...
If you want to use a parallax scrolling background, set the two following config properties when initializing reveal.js (the other three are optional).
...
Reveal.initialize({
	...
	// Amount to move parallax background (horizontal and vertical) on slide change
	// If this isn't specified it will be calculated automatically
	// (optional)
